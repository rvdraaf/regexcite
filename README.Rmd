...
**NOTE: This is package was created for exploratory reasons by following the tutorial hosted on https://r-pkgs.org/whole-game.html, written by Hadley Wickham and Jennifer Bryan. It is not meant to actually be useful. If you want a package for factor handling, please see [stringr](https://stringr.tidyverse.org), [stringi](https://stringi.gagolewski.com/),
